...
const MODEL_PATH: &'static str = "examples/vulkan/assets/chalet.obj";
const TEXTURE_PATH: &'static str = "examples/vulkan/assets/chalet.jpg";
...
impl VulkanGame {
    pub fn new(game_loop: &game_loop::GameLoop) -> VulkanGame {
        /*let window =
        ...
        let render_pass = VulkanGame::create_render_pass(
            &instance,
            &device,
            physical_device,
            swapchain_stuff.swapchain_format,
        ...
        let (graphics_pipeline, pipeline_layout) = VulkanGame::create_graphics_pipeline(
            &device,
            render_pass,
        ...
        let swapchain_framebuffers = VulkanGame::create_framebuffers(
            &device,
            render_pass,
        ...
        VulkanGame::check_mipmap_support(&instance, physical_device, vk::Format::R8G8B8A8_UNORM);
        let (texture_image, texture_image_memory, mip_levels) = VulkanGame::create_texture_image(
            &device,
            command_pool,
            graphics_queue,
            &physical_device_memory_properties,
        ...
        let texture_sampler = VulkanGame::create_texture_sampler(&device, mip_levels);
        ...
        let command_buffers = VulkanGame::create_command_buffers(
            &device,
            command_pool,
            graphics_pipeline,
...
impl VulkanGame {
    ...
    fn recreate_swapchain(&mut self) {
        ...
        self.render_pass = VulkanGame::create_render_pass(
            &self.instance,
            &self.device,
            self.physical_device,
            self.swapchain_format,
        ...
        self.swapchain_framebuffers = VulkanGame::create_framebuffers(
            &self.device,
            self.render_pass,
        ...
        self.command_buffers = VulkanGame::create_command_buffers(
            &self.device,
            self.command_pool,
